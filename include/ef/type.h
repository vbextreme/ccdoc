...
#define __target_mmx    __target("mmx")
#define __target_sse    __target("sse")
#define __target_sse2   __target("sse2")
#define __target_sse3   __target("sse3")
#define __target_ssse3  __target("ssse3")
#define __target_sse41  __target("sse4.1")
#define __target_sse42  __target("sse4.2")
#define __target_avx    __target("avx")
#define __target_avx2   __target("avx2")
#define __target_avx512 __target("avx512f")
#ifdef __clang__
...
#define __cpu_supports_mmx    __builtin_cpu_supports("mmx")
#define __cpu_supports_sse    __builtin_cpu_supports("sse")
#define __cpu_supports_sse2   __builtin_cpu_supports("sse2")
#define __cpu_supports_sse3   __builtin_cpu_supports("sse3")
#define __cpu_supports_ssse3  __builtin_cpu_supports("ssse3")
#define __cpu_supports_sse41  __builtin_cpu_supports("sse4.1")
#define __cpu_supports_sse42  __builtin_cpu_supports("sse4.2")
#define __cpu_supports_avx    __builtin_cpu_supports("avx")
#define __cpu_supports_avx2   __builtin_cpu_supports("avx2")
#define __cpu_supports_avx512 __builtin_cpu_supports("avx512f")
...
#ifdef __clang__
#	define GCC_PUSH_OPTIONS
#	define GCC_POP_OPTIONS
#	define GCC_OPTIMIZE(OPT)
#else
#	define GCC_PUSH_OPTIONS DO_PRAGMA(GCC push_options)
#	define GCC_POP_OPTIONS  DO_PRAGMA(GCC pop_options)
#	define GCC_OPTIMIZE(OPT) DO_PRAGMA(GCC optimize(OPT))
#endif
...
#define die(FORMAT, arg...) do{\
	fprintf(DBG_OUTPUT, DBG_COLOR_ERROR "die" DBG_COLOR_INFO " %s[%u]{%ld} %s()::" DBG_COLOR_RESET FORMAT "\n",\
		__FILE__,\
		__LINE__,\
		pthread_self(),\
		__FUNCTION__,\
